        ...
        <>
          <main className={`flex fira flex-col justify-between px-4 md:px-0`}>
            ...
            <p className="font-light text-lg">
              ...
              <span className="bg-green-600 rounded-lg px-1.5">
                Full Stack Intern
              </span>{" "}
              at OneBigBit Technologies Pvt. Ltd. During my internship, I
              focussed on developing applications using{" "}
              <span className="bg-green-600 rounded-lg px-1.5">MERN</span> stack
              technology and{" "}
              <span className="bg-green-600  rounded-lg px-1.5">Firebase</span>.
              ...
              <span className="bg-blue-700 rounded-lg px-1.5">
                Image matching
              </span>{" "}
              using LoFTR and{" "}
              <span className="bg-blue-700 rounded-lg px-1.5">
              ...
              <span className="bg-blue-700 rounded-lg px-1.5">DAPCOM 2024</span>{" "}
              and{" "}
              <span className="bg-blue-700 rounded-lg px-1.5">AITC 2024</span>.
              <br />
              ...
              <span className="bg-red-500 rounded-lg px-1.5">AWS</span> - such
              as <span className="bg-red-500 rounded-lg px-1.5">EC2</span> and{" "}
              <span className="bg-red-500 rounded-lg px-1.5">Lambda</span>,
              ...
              shortlisted for{" "}
              <span className="bg-teal-700 rounded-lg px-1.5">
                Smart India Hackathon
              </span>{" "}
              finals 2022 at Mangalore. I have also served as{" "}
              <span className="bg-teal-700 rounded-lg px-1.5">President</span> of
